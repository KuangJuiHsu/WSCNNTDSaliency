classdef SaliencyAccuracy < dagnn.Loss
...
%       labels = gather(inputs{2}) ;
      ...
      obj.average = gather([obj.meanIntersectionUnion; obj.pixelAccuracy ; obj.meanAccuracy;]);
      obj.numAveraged = gather(obj.numAveraged + numPixels);
      outputs{1} = gather(obj.average);
    end
    ...
    function obj = SaliencyAccuracy(varargin)
      obj.load(varargin) ;
    end
  end
end
