function net = fcnInitializeSaliencyModel(varargin)
...
% Modify the last fully-connected layer to have "NumClasses = 2" output classes
...
filters = single(bilinear_u(64, NumClasses, NumClasses)) ;
